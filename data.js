...
window.HOTSPOTS = [
  {
    x: 61.8, y: 43.8, n: 1, // x:62.7% y:43.9%
    title: "Acciones generales módulo perfiles: ",
    text: "Se encuentra un campo de búsqueda el cual filtra según los parámetros insertados, se tiene el botón de exportar el cual permite descargar el listado de los perfiles registrados en el sistema en diferentes formatos, se tiene el botón para crear un nuevo perfil."
  },
  {
    x: 87.0, y: 56.1, n: 2, // x:87.0% y:55.4%
    title: "Acciones perfil: ",
    text: "Estas acciones permiten gestionar un perfil seleccionado, se tiene el botón para editar el perfil. En este caso no se puede eliminar el perfil."
  },
];
...
window.BUTTONS = [
  ...
  {
    x:10.9, y:62.7, // Cuentas ABT x:9.9% y:62.5%
    label: "+",
    href: "https://wilvar88.github.io/SIR-Gesti-n-ABT-Cuentas/",
    target: "self",
    // Si quieres totalmente transparente, puedes usar la variante 'transparent'
    // (ojo: pone background transparente con !important)
    variant: "transparent",
